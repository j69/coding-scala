...
import udemy.advanced1.module1.support.KoanSuite
...
class Module01HeapSolutions extends KoanSuite with Matchers {
  ...
  test("should enforce limits on daily") {
    ...
    intercept[IllegalArgumentException] {
      tracker.dailyMax = -100
    }
    intercept[IllegalArgumentException] {
      tracker.dailyMax = 5000
    } // should allow up to 4999 calories only
  }
